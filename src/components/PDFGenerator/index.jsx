...
import { MyAssets } from "../PDFAssets";
import { CabeceraBE } from "./CabeceraBE";
import { useImagePDF } from "../../Hooks/useImagePDF";
import { useFormatDocument } from "../../Hooks/useFormatDocument";
import { TableAssetsValeBaja } from "./TableAssetsValeBaja";
import { CabeceraCL } from "./CabeceraCL";
import { TableAssetsCheckList } from "../PDFAssets/TableAssetsCheckList";
import { TableComponents } from "../PDFAssets/TableComponents";


function generatePDF(dataDocument, typeFormat ) {
  ...
  const { initialStore } = dataDocument ? dataDocument : [];
...
function MyDocument({ dataDocument }) {
  ...
  return (
    generatePDF(dataDocument, typeFormat )
